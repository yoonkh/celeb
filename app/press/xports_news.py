...
TARGET_URL_BEFORE_MAIN = 'http://www.xportsnews.com'
TARGET_URL_BEFORE_KEYWORD = '/?ac=article_search&skey=tc&sword='
...
def get_link_from_news_title(page_num, URL, type, press):
    ...
    for i in range(page_num):
        ...
        for title in soup.select('dl.dlist > dt > a'):
            # print(title)
            ...
            content_of_article = soup.select('span.newsView > div')

            tit = soup.select('div#articleSubecjt > h3')
